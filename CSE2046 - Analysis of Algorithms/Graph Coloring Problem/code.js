...
const  inputFilePath  = "./test4.txt"
const  outputFileName = "./output4.txt"
...
let content =
  firstMethodColorNumber < secondMethodColorNumber && firstMethodColorNumber < thirdMethodColorNumber
    ? contentFirst
